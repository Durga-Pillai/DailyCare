    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <h2 style={{
              ...
              color: 'var(--slate-900)', letterSpacing: '-0.3px', marginBottom: '3px',
            }}>
              New Task
            </h2>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          {/* Category and Role — stack on mobile */}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange} style={field}
              onFocus={e => (e.target.style.borderColor = 'var(--blue-500)')}
              onBlur={e  => (e.target.style.borderColor = 'var(--slate-200)')}
            />
          </div>
          ...
          {isError && (
            <div style={{
              ...
              border: '1px solid var(--red-100)', borderRadius: 'var(--radius-sm)',
              color: 'var(--red-600)', fontSize: '12px',
            }}>
